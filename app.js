function main() {
  ...
  class BasicCharacterController {
    ...
    _LoadModels() {
      ...
      loader.setPath("resources/avatar.glb");
      loader.load("avatar.glb", (glb) => {
  ...
  class CharacterControllerDemo {
    ...
    _LoadAnimatedModelAndPlay(path, modelFile, animFile, offset) {
      ...
      loader.load(modelFile, (glb) => {
        ...
        anim.load(animFile, (anim) => {
          const m = new THREE.AnimationMixer(glb);
          this._mixers.push(m);
    ...
    _LoadModel() {
      const loader = new GLTFLoader();
      loader.load("resources/avatar.glb", (glb) => {
  ...
  //   const url = 'resources/skybox/scene.gltf';
...
function ambientSetup() {
  ...
  var pointLight = new THREE.PointLight(0xffc5cb, 0.8);
